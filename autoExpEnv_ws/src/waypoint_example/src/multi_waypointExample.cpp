...
int main(int argc, char** argv)
{
  ...
  auto subPose = nh->create_subscription<nav_msgs::msg::Odometry>("/"+robot_name+"/state_estimation", 5, poseHandler);
  
  auto pubWaypoint = nh->create_publisher<geometry_msgs::msg::PointStamped>("/"+robot_name+"/way_point", 5);
  geometry_msgs::msg::PointStamped waypointMsgs;
  waypointMsgs.header.frame_id = robot_name+"map";
  
  auto pubSpeed = nh->create_publisher<std_msgs::msg::Float32>("/"+robot_name+"/speed", 5);
  std_msgs::msg::Float32 speedMsgs;
  
  auto pubBoundary = nh->create_publisher<geometry_msgs::msg::PolygonStamped>("/"+robot_name+"/navigation_boundary", 5);
  geometry_msgs::msg::PolygonStamped boundaryMsgs;
  boundaryMsgs.header.frame_id = robot_name+"map";

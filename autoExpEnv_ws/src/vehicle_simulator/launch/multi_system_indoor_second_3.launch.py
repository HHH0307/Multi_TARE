...
def generate_launch_description():
    ...
    # 参数声明列表
    declare_args = [
        DeclareLaunchArgument('world_name', default_value='indoor_2', description='仿真环境名称'),
        ...
        DeclareLaunchArgument('robot_2_vehicleZ', default_value='0.0', description='2机器人Z坐标'),
        DeclareLaunchArgument('robot_2_terrainZ', default_value='0.0', description='2地形Z坐标'),
        DeclareLaunchArgument('robot_2_vehicleYaw', default_value='0.0', description='机器人2偏航角'),

        # 机器人1参数
        DeclareLaunchArgument('robot_3_vehicleX', default_value='0.0', description='robot_3的X坐标'),
        DeclareLaunchArgument('robot_3_vehicleY', default_value='1.5', description='robot_3的Y坐标'),
        DeclareLaunchArgument('robot_3_vehicleZ', default_value='0.0', description='3机器人Z坐标'),
        DeclareLaunchArgument('robot_3_terrainZ', default_value='0.0', description='3地形Z坐标'),
        DeclareLaunchArgument('robot_3_vehicleYaw', default_value='0.0', description='机器人3偏航角')
    ]

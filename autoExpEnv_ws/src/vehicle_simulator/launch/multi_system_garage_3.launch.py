...
def generate_launch_description():
    ...
    declare_args = [
        ...
        # 机器人1参数
        DeclareLaunchArgument('robot_2_vehicleX', default_value='-1.0', description='robot_2的X坐标'),
        DeclareLaunchArgument('robot_2_vehicleY', default_value='2.0', description='robot_2的Y坐标'),

...
def generate_launch_description():
    ...
    declare_args = [
        ...
        DeclareLaunchArgument('robot_3', default_value='robot_3', description=''),
        ...
        DeclareLaunchArgument('robot_3_vehicleX', default_value='0.0', description=''),
        DeclareLaunchArgument('robot_3_vehicleY', default_value='1.5', description=''),
        DeclareLaunchArgument('robot_3_vehicleZ', default_value='0.0', description=''),
        DeclareLaunchArgument('robot_3_terrainZ', default_value='0.0', description=''),
        DeclareLaunchArgument('robot_3_vehicleYaw', default_value='0.0', description=''),
        ...
        actions=[
            ...
            Node(
                ...
                parameters=[{
                    ...
                    'vehicleHeight': vehicleHeight,
                    'cameraOffsetZ': cameraOffsetZ,
                    'vehicleX': robot_3_vehicleX,
                    'vehicleY': robot_3_vehicleY,
                    'vehicleZ': robot_3_vehicleZ,
                    'terrainZ': robot_3_terrainZ,
                    'vehicleYaw': robot_3_vehicleYaw,
                    'terrainVoxelSize': terrainVoxelSize,
                    'groundHeightThre': groundHeightThre,
                    'adjustZ': adjustZ,
                    'terrainRadiusZ': terrainRadiusZ,

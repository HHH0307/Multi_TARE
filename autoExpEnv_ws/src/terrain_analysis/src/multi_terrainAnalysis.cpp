...
int main(int argc, char **argv) {
  ...
  auto subClearing = nh->create_subscription<std_msgs::msg::Float32>("/"+robot_name+"/map_clearing", 5, clearingHandler);

  auto pubLaserCloud = nh->create_publisher<sensor_msgs::msg::PointCloud2>("/"+robot_name+"/terrain_map", 2);
